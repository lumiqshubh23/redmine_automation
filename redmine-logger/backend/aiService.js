...
async function summarizeCommit(message, patch) {
    // Dynamically reload .env to reflect changes (e.g. DISABLE_AI) without restarting backend
    try {
        ...
        console.warn("[aiService] Failed to reload .env dynamically:", err.message);
    }
